...
public interface EmpresaRepository extends JpaRepository<Empresa,Integer> {
	...
	public final static String GET_USERS_BY_IDEMPRESA = "SELECT u.email,u.enabled,u.first_name, u.genero,u.id,u.id_estatus,"
			+ "u.last_name,u.phone_number,u.username FROM puesto p inner join users u on p.id_usuario = u.id  where p.id_empresa = :id_empresa";
	...
	@Query(value = GET_USERS_BY_IDEMPRESA , nativeQuery = true)
	List<User> getUserByIdEmpresa(@Param("id_empresa") Integer id_empresa); 
